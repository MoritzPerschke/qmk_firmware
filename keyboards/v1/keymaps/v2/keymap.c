...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT(
        ...
        KC_TAB,  KC_NO,   KC_Q,   KC_W,   KC_E,       KC_R,    KC_TRNS,          KC_TRNS,   KC_Y,   KC_U,        KC_I,    KC_O,   KC_P,    KC_BSPC,
        KC_DEL,  KC_LSFT, KC_A,    KC_S,   KC_D,       KC_F,   KC_H,          KC_TRNS,     KC_H,   KC_J,        KC_K,    KC_L,   KC_SCLN, KC_QUOT,
        SC_LSPO, KC_Z,    KC_X,    KC_C,   KC_V,       KC_B,   KC_TRNS,          KC_TRNS,     KC_N,   KC_M,        KC_COMM, KC_DOT, KC_SLSH, SC_RSPC,
                          KC_MINS, KC_EQL, KC_ESC, KC_SPC, KC_LSFT,               KC_ENT,      KC_SPC, MO(_NUMPAD), KC_LBRC, KC_RBRC,
                                                    KC_LCTL, KC_LALT,             KC_RGUI,     KC_BSPC
    ),
